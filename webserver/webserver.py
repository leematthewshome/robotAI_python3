...
class webServer(object):
    ...
    # function to setup routes and run server
    #======================================================
    def runWebserver(self):
    
        #default page for administration website
        #-----------------------------------------------------
        ...
        #-----------------------------------------------------
        @self.websrvApp.route('/config.html')
        def config():
        ...
        #-----------------------------------------------------
        @self.websrvApp.route('/config_save.html', methods=['GET', 'POST'])
        def config_save():
            message = ""
            thisCat = request.args.get("cat")
            filename = os.path.join(self.TOPDIR, "static/sqlite/robotAI.sqlite")
        ...
        #-----------------------------------------------------
        @self.websrvApp.route('/contacts.html')
        def contacts():
        ...
        @self.websrvApp.route('/<path:path>')
        def catch_all(path):
...
# ==========================================================================
# Function called by main robotAI process to run the web server
# ==========================================================================
def doWebserver(ENVIRON, SENSORQ, MIC):
